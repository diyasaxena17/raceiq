...
SCENARIOS = {
    ...
    "monaco-track-position": StrategyScenario(
        ...
        dashboard=build_dashboard(
            ...
            tyre_data=[
                TyrePoint(lap=25, medium=0.08, hard=0.05, projected=0.08),
                TyrePoint(lap=30, medium=0.12, hard=0.08, projected=0.11),
                TyrePoint(lap=35, medium=0.18, hard=0.12, projected=0.16),
                TyrePoint(lap=42, medium=0.25, hard=0.18, projected=0.23),
                TyrePoint(lap=50, medium=0.38, hard=0.27, projected=0.34),
                TyrePoint(lap=58, medium=0.52, hard=0.39, projected=0.48),
            ],
            branches=[
                StrategyBranch(
                    label="Stay out",
