...
export const raceScenarios: RaceScenario[] = [
  ...
  },
  {
    ...
    prediction: {
      ...
      confidence: 0.78,
      reason: "The soft tyre is fading, but clean air is unavailable and track position is worth more than the stop.",
      risk_level: "low",
    ...
    data: {
      ...
      tyreData: [
        { lap: 25, medium: 0.08, hard: 0.05, projected: 0.08 },
        { lap: 30, medium: 0.12, hard: 0.08, projected: 0.11 },
        { lap: 35, medium: 0.18, hard: 0.12, projected: 0.16 },
        { lap: 42, medium: 0.25, hard: 0.18, projected: 0.23 },
        { lap: 50, medium: 0.38, hard: 0.27, projected: 0.34 },
        { lap: 58, medium: 0.52, hard: 0.39, projected: 0.48 },
      ],
      strategyBranches: [
        {
          label: "Stay out",
